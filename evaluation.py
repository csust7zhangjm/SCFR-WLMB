...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default='/root/autodl-tmp/datasets/LOL/eval15/high', type=str)
    parser.add_argument('-dirB', default='/root/code/SCFR_WLMB/our_results', type=str)
