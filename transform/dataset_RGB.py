...
class DataLoaderTest_(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        ...
        clean_files = sorted(os.listdir(os.path.join(rgb_dir, 'hgh')))
        noisy_files = sorted(os.listdir(os.path.join(rgb_dir, 'low')))

        self.clean_filenames = [os.path.join(rgb_dir, 'high', x) for x in clean_files if is_image_file(x)]
        self.noisy_filenames = [os.path.join(rgb_dir, 'low', x) for x in noisy_files if is_image_file(x)]
